Feature: memory
  ...
  Scenario: collection text of elements
    ...
    Then I expect '$memory' memory value to deeply equal '$js(["first value", "second value", "third value"])'
  ...
  Scenario: collection attribute of elements
    ...
    Then I expect '$memory' memory value to deeply equal '$js(["firstValue", "secondValue", "thirdValue"])'
